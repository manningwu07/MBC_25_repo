...
export const GET = async (req: Request) => {
  ...
  const response: ActionGetResponse = {
    type: "action",
    icon: `${new URL("/gaza.jpg", req.url).toString()}`,
    label: "1 SOL",
      ...
      actions: [
        {
          ...
          href: `/api/actions/donate-sol-gaza?amount=0.01`,
        },
        {
          type: "transaction",
          label: "0.05 SOL",
          href: `/api/actions/donate-sol-gaza?amount=0.05`,
        },
        {
          type: "transaction",
          label: "0.1 SOL",
          href: `/api/actions/donate-sol-gaza?amount=0.1`,
        },
        {
          // Example for a custom input field
          type: "transaction",
          href: `/api/actions/donate-sol-gaza?amount={amount}`,
          label: "Donate",
          parameters: [
            {
              name: "amount",
